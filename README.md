...
mainly focusing on the [ÖNB-API-IIIF][oenb-api-iiif] for now.
Also, it is very basic by design. This is just supposed to be a weekend project.

## About [ÖNB-API-IIIF][oenb-api-iiif]

[ÖNB-API-IIIF][oenb-api-iiif] is based on the project “Simple Access to Cultural
...
[oenb-api-iiif]: https://iiif.onb.ac.at/api/
